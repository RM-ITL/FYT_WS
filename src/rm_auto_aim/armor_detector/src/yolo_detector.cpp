...
const std::array<YoloDetector::ClassInfo, kClassCount> kClassMap = {{
    ...
    {EnemyColor::BLUE, "one", ArmorType::SMALL},
    {EnemyColor::RED, "one", ArmorType::SMALL},
    {EnemyColor::WHITE, "one", ArmorType::SMALL},
    {EnemyColor::BLUE, "two", ArmorType::SMALL},
    {EnemyColor::RED, "two", ArmorType::SMALL},
    {EnemyColor::WHITE, "two", ArmorType::SMALL},
    {EnemyColor::BLUE, "three", ArmorType::SMALL},
    {EnemyColor::RED, "three", ArmorType::SMALL},
    {EnemyColor::WHITE, "three", ArmorType::SMALL},
    {EnemyColor::BLUE, "four", ArmorType::SMALL},
    {EnemyColor::RED, "four", ArmorType::SMALL},
    {EnemyColor::WHITE, "four", ArmorType::SMALL},
    {EnemyColor::BLUE, "five", ArmorType::SMALL},
    {EnemyColor::RED, "five", ArmorType::SMALL},
    {EnemyColor::WHITE, "five", ArmorType::SMALL},
    ...
    {EnemyColor::WHITE, "base", ArmorType::SMALL},
    {EnemyColor::BLUE, "three", ArmorType::LARGE},
    {EnemyColor::RED, "three", ArmorType::LARGE},
    {EnemyColor::WHITE, "three", ArmorType::LARGE},
    {EnemyColor::BLUE, "four", ArmorType::LARGE},
    {EnemyColor::RED, "four", ArmorType::LARGE},
    {EnemyColor::WHITE, "four", ArmorType::LARGE},
    {EnemyColor::BLUE, "five", ArmorType::LARGE},
    {EnemyColor::RED, "five", ArmorType::LARGE},
    {EnemyColor::WHITE, "five", ArmorType::LARGE},
}};
}  // namespace
